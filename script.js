...
const I18N = {
  en: {
    ...
    textById: {
      'hero-subtitle': 'Discover Diakopto, Achaea! Your travel guide to this seaside village, the Corinthian Gulf beaches, and the Odontotos railway route through the Vouraikos gorge.',
      ...
      'odontotos-subtitle': 'The historic Odontotos railway, inaugurated in 1896, crosses the 22-kilometer Vouraikos gorge by activating its special rack-and-pinion system to climb steep mountain gradients that reach 17.5%.',
      ...
      'gorge-subtitle': 'This impressive 20-kilometer rift forms a rare geological landscape, where the historic Odontotos railway of 1896 climbs across 49 bridges and through dark tunnels with natural stalactites between the Niamata and Triklia stations.',
      'gorge-discover': '→ Discover',
      'gorge-maps': 'Google Maps ↗',
      'beaches-title': 'Beaches',
      'beaches-subtitle': 'Discover the coastal richness of the area by diving into the deep blue waters of Punta, Elaionas, and Egkali.',
      'beaches-discover': '→ Discover',
      'beaches-maps': 'Google Maps ↗',
      'local-title': 'Local Life',
      'local-subtitle': 'Local life in Diakopto unfolds around its picturesque little harbor, where residents enjoy fresh fish with views of the Corinthian Gulf.',
      ...
      'outro-subtitle': 'Diakopto harmoniously connects the Corinthian Gulf with the mountainous massif of Helmos, offering travelers the rare opportunity to board the historic Odontotos railway of 1896, explore the mountains along the European E4 trail, dive in the deep waters of Punta\'s white beach, and taste fresh fish at the picturesque harbor of this seaside settlement.',
      'outro-stay': 'STAY',
      'outro-train': 'TRAIN',
      'outro-map': 'MAP',
      'outro-plan': 'PLAN',
  ...
  el: {
    ...
    textById: {
      'hero-subtitle': 'Ανακαλύψτε το Διακοπτό Αχαΐας! Ο ταξιδιωτικός οδηγός για τον παραθαλάσσιο οικισμό, τις παραλίες του Κορινθιακού και τη διαδρομή με τον Οδοντωτό στο φαράγγι του Βουραϊκού ποταμού.',
      'hero-maps-label': 'Google Maps',
      'hero-stay': 'ΔΙΑΜΟΝΗ',
      'hero-train': 'ΤΡΑΙΝΟ',
